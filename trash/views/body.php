...
/* Default styling for the home section */
.home {
  position: relative;
  height: 100vh;
  justify-content: center;
...
.home .background {
  ...
  width: 100%;
  height: 100%;
  background: linear-gradient(to right, rgba(45, 22, 116, 1) -2%, rgba(45, 22, 116, 0) 100%);
  z-index: 0; /* Adjusted z-index here */
}

  
  /* Responsive styling for the content */
  .content {
    display: flex;
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="modal">Account Needed</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        You must login or create account first.
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button type="button" onclick="login()" class="btn btn-primary">Yes</button>
      </div>
    </div>
  </div>
</div>
